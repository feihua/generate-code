...
func init() {
	...
	//main.exe golang gorm --dsn "root:ad879037-c7a4-4063-9236-6bfc35d54b7d@tcp(139.159.180.129:3306)/gozero" --tableNames sys_ --prefix sys_
...
func Generate(t utils.Table) error {
	tpl, err := template.ParseFiles("template/go/gorm.tpl")
