...
func init() {
	...
	//go run main.go rust actix --dsn "root:oMbPi5munxCsBSsiLoPV@tcp(110.41.179.89:3306)/better-pay" --tableNames pay_ --prefix pay_  --orm rbatis --author LiuFeiHua --packageName pay
