...
`,
	Run: func(c *cobra.Command, args []string) {
		...
		var path = "generate/rust/axum"
		for _, t := range tables {
			Generate(t, "template/rust/axum/vo.tpl", path+"/vo", t.RustName+"_vo.rs")
			Generate(t, "template/rust/axum/model.tpl", path+"/model", t.RustName+".rs")
			Generate(t, "template/rust/axum/handler.tpl", path+"/handler", t.RustName+"_handler.rs")
		}
	},
}
...
func init() {
	...
	//rust axum --dsn "root:ad879037-c7a4-4063-9236-6bfc35d54b7d@tcp(139.159.180.129:3306)/gozero" --tableNames sys_ --prefix sys_
